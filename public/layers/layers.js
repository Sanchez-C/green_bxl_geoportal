...
var lyr_md_gardens_rel = new ol.layer.Vector({
                            source: new ol.source.Vector({
                              format: new ol.format.GeoJSON({
                              }),
                              strategy: ol.loadingstrategy.bbox,
                              url: "http://localhost:8080/geoserver/green_brussels/wfs?service=WFS&version=1.1.0&request=GetFeature&typeName=green_brussels:md_green_spaces&outputFormat=application/json&srsname=EPSG:3857"
                            }),
...
var lyr_md_gardens_nb = new ol.layer.Vector({
                            source: new ol.source.Vector({
                              format: new ol.format.GeoJSON({
                              }),
                              strategy: ol.loadingstrategy.bbox,
...
var lyr_md_green_spaces = new ol.layer.Vector({
                            source: new ol.source.Vector({
                              format: new ol.format.GeoJSON({
                              }),
                              strategy: ol.loadingstrategy.bbox,
...
var lyr_md_surfaces_imp = new ol.layer.Vector({
                            source: new ol.source.Vector({
                              format: new ol.format.GeoJSON({
                              }),
                              strategy: ol.loadingstrategy.bbox,
...
var lyr_md_surfaces_veg = new ol.layer.Vector({
                            source: new ol.source.Vector({
                              format: new ol.format.GeoJSON({
                              }),
                              strategy: ol.loadingstrategy.bbox,
...
var lyr_md_densite = new ol.layer.Vector({
                            source: new ol.source.Vector({
                              format: new ol.format.GeoJSON({
                              }),
                              strategy: ol.loadingstrategy.bbox,
                              url: "http://localhost:8080/geoserver/green_brussels/wfs?service=WFS&version=1.1.0&request=GetFeature&typeName=green_brussels:md_population&outputFormat=application/json&srsname=EPSG:3857"
                            }),
...
var lyr_md_households_size = new ol.layer.Vector({
                            source: new ol.source.Vector({
                              format: new ol.format.GeoJSON({
                              }),
                              strategy: ol.loadingstrategy.bbox,
...
var lyr_md_noise_lden = new ol.layer.Vector({
                            source: new ol.source.Vector({
                              format: new ol.format.GeoJSON({
                              }),
                              strategy: ol.loadingstrategy.bbox,
                              url: "http://localhost:8080/geoserver/green_brussels/wfs?service=WFS&version=1.1.0&request=GetFeature&typeName=green_brussels:md_noise&outputFormat=application/json&srsname=EPSG:3857",
                            }),
...
var lyr_md_noise_ln = new ol.layer.Vector({
                            source: new ol.source.Vector({
                              format: new ol.format.GeoJSON({
                              }),
                              strategy: ol.loadingstrategy.bbox,
